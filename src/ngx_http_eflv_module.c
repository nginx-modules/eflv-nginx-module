...
ngx_int_t ngx_http_tflv_handler(ngx_http_request_t *r);
ngx_int_t ngx_http_sflv_handler(ngx_http_request_t *r);
...
ngx_http_tflv_handler(ngx_http_request_t *r)
{
    ...
    log->action = "sending eflv to client";
